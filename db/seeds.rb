...
User.create({email: "mikebarile13@gmail.com", password: "password", first_name: "Mike", last_name: "Barile", is_host: true, image_url: "https://res.cloudinary.com/dsguwnfdw/image/upload/v1478283164/People/headshot.jpg"})
